...
public class User {
	...
	public String toString() {
		return "User(id=" + this.getId() + ", username=" + this.getUsername() + ", firstName=" + this.getFirstName() + ", lastName=" + this.getLastName() + ", email=" + this.getEmail() + ", lastUpdated=" + this.getLastUpdated() + ", active=" + this.isActive() + ")";
	}
